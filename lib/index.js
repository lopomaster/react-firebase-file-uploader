  ...
  _createClass(FirebaseFileUploader, [{
    ...
    value: function startUpload(file) {
      ...
      var _props = this.props,
          ...
          ensureExtension = _props.ensureExtension
      ...
      if (this.props.ensureExtension && !extractExtension(filenameToUse)) {
    ...
    value: function render() {
      var _props2 = this.props,
          ...
          ensureExtension = _props2.ensureExtension
          _props2$as = _props2.as,
          Input = _props2$as === undefined ? 'input' : _props2$as,
          props = _objectWithoutProperties(_props2, ['storageRef', 'onUploadStart', 'onProgress', 'onUploadSuccess', 'onUploadError', 'randomizeFilename', 'metadata', 'filename', 'maxWidth', 'maxHeight', 'hidden', 'as', 'ensureExtension']);
